...
struct WindowPushConstants { float ndcX0, ndcY0, ndcX1, ndcY1; int swapRB; };
...
private:
    ...
    static constexpr size_t AHB_CACHE_MAX_NORMAL  = 16;
    static constexpr size_t AHB_CACHE_MAX_SCANOUT =  4;
